  ...
  const fetchUnassignedSlots = async (authToken: string, schoolId: number) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/v1/academic/unassigned-slots?school_id=${schoolId}`,
        {
          headers: { 
    ...
    return (
      <MainLayout>
        <div className="flex flex-col items-center justify-center h-96">
          ...
          <p className="text-gray-500 mt-4 animate-pulse">Loading unassigned slots...</p>
        </div>
      </MainLayout>
    )
  }
  ...
  return (
    <MainLayout>
      <div className="space-y-6 p-6 animate-fadeIn">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-yellow-600 via-amber-600 to-orange-600 p-8 text-white shadow-xl">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold mb-2">Unassigned Subjects</h1>
              <p className="text-amber-100 max-w-2xl">
                Subjects, classes, and streams that need teacher assignment. 
                Assign teachers to ensure complete coverage.
        ...
        <Card className="shadow-xl border-0 overflow-hidden rounded-2xl">
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 font-medium">Total Unassigned Slots</p>
            ...
            {total === 0 ? (
              <div className="text-center py-16">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-lg font-medium text-gray-800">All subjects are assigned!</p>
                  <p className="text-sm text-gray-500">Every subject has a teacher assigned. Great job! 🎉</p>
                </div>
              </div>
            ) : (
                      ...
                      >
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-700">{slot.stream_name || "All Streams"}</span>
                          </div>
                        </TableCell>
                        <TableCell className="text-right">
                          <Button
                            size="sm"
                            onClick={() => router.push(
                              `/teachers?assign_subject=${slot.subject_id}&class_id=${slot.class_id}&stream_id=${slot.stream_id || ''}`
                            )}
        ...
        {/* Info Box */}
        <Card className="shadow-lg border-0 overflow-hidden bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl">
          ...
          <CardContent className="pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
              <div className="flex items-start gap-2">
                ...
                <span>Click "Assign Teacher" for any unassigned slot</span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>You will be redirected to the Teachers page</span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>Select a teacher and assign the subject, class, and stream</span>
              </div>
            </div>
